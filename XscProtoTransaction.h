...
private:
	...
	bool decodeContinue(xsc_tlv_node* root); 
	bool decodeDialog(xsc_tlv_node* root); 
	bool decodeCancel(xsc_tlv_node* root); 
	bool decodeAbort(xsc_tlv_node* root); 
...
public:
	...
	static void encodeUnidirection(const string& msg, uchar* dat, int len, xsc_tlv_pdu* xtp); 
